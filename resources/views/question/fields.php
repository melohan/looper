...
<div class="row">
    <?php if (!is_null($exercise)) : ?>
        <section class="column">
            ...
            <a data-confirm="Are you sure? You won&#39;t be able to further edit this exercise" class="button" rel="nofollow" data-method="put" data-href="/exercise/update" data-val="<?= $exercise->getid() ?>" data-status="2"><i class="fa fa-comment"></i>
